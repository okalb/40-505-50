// ===============================================
// Bicep template for LAB565 - Microsoft 365 Copilot Agents-OK
...
// (Uses param if provided; otherwise RG location)
// ===============================================
...
// Prefer the resource method (also fixes the linter warning)
